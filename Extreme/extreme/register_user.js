    ...
    return(
        <NativeBaseProvider>
            ...
            style={{
                ...
                <Button style={{backgroundColor:'#ced4da', width:100, height:30,alignItems:'center',paddingBottom:2}}><Text style={{fontSize:16 ,height:30}}>중복확인</Text></Button>
                </HStack>
                ...
                <Box>
                  <HStack space={20} marginTop={10}>
                     ...
                     <Button style={{width:100, height:40,borderWidth:1,justifyContent:'center',backgroundColor:'white'}}><Text>취소</Text></Button>  
                  </HStack>   
                </Box>
                </Box>
        </NativeBaseProvider>
